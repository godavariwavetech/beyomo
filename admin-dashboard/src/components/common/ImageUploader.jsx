...
const ImageUploader = ({ value, onChange, width = 80, height = 48 }) => {
      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
        ...
        <div>
          <label style={{ display: 'block' }}>
            <input type="file" accept="image/jpeg,image/jpg,image/png,image/webp" style={{ display: 'none' }} onChange={handleFile} disabled={uploading} />
