...
const ICON_MAP: Record<string, {icon: string; iconColor: string; iconBg: string}> = {
  new_job:          {icon: 'briefcase',        iconColor: '#105641', iconBg: '#EAF5F0'},
  job_confirmed:    {icon: 'checkmark-circle', iconColor: '#105641', iconBg: '#EAF5F0'},
  job_cancelled:    {icon: 'close-circle',     iconColor: '#FB1616', iconBg: '#FFF0F0'},
  payout:           {icon: 'wallet',           iconColor: '#C49738', iconBg: '#FFF8E7'},
