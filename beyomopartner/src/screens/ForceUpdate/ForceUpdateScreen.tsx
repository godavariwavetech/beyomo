...
const DEFAULT_STORE_URL = 'https://play.google.com/store/apps/details?id=com.beyomopartner';
  ...
  return (
    <LinearGradient colors={['#0E5843', '#022723']} style={styles.container} start={{x: 0, y: 0}} end={{x: 0, y: 1}}>
      ...
      <Text style={styles.subtitle}>
        {message || 'A new version of the app is available. Please update to continue using Beyomo Partner.'}
      </Text>
