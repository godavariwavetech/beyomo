...
const FAQS: FAQ[] = [
  ...
  {id: '5', q: 'What do I do when I reach the customer\'s location?', a: 'Open the job and swipe "Reached to Customer Location". Ask the customer for the 4-digit OTP shown on their booking and enter it to verify — then review the services on the checklist and swipe "Start Service" to begin. The job can\'t be started until the OTP is verified.'},
