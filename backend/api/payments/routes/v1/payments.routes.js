...
const { createOrder, createQuoteOrder, verifyPayment, getHistory, webhook } = require("../../controllers/v1/payments.controller");
...
router.post("/quote-order", createQuoteOrder);
